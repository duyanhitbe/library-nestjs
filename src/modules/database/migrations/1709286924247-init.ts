...
export class Init1709286924247 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "book_infos" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "is_active" boolean NOT NULL DEFAULT true, "name" character varying NOT NULL, "author" character varying NOT NULL, "publish_date" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "PK_e6079dc9902c192a7955722de57" PRIMARY KEY ("id"))`);
